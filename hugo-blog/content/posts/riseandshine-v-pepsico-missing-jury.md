...
Put the two positions side by side and notice what they share. The petitioner wants strength in the jury box. The Second Circuit wants it on the bench. Both picture a courtroom where the choice matters because a factfinder is seated. My new essay, *The Missing Jury: Fact, Law, and Who Actually Decides Trademark Confusion*, measures that picture against the docket.
...
The essay is deliberately neutral on the question presented; it maps the terrain the answer will govern. Whichever label wins, the rule will operate almost entirely at summary judgment, in the rare contested case, on a paper record.

The full essay is on SSRN [here](https://ssrn.com/abstract=7045278), and it is a fast read as these things go. The Court has been asked to choose between judge and jury. For twenty years, the docket has been choosing for it.
